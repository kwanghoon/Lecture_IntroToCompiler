...
public enum Token {
	...
	SECONDS("seconds"), STORAGE("storage"), STRING_LITERAL("string_literal"),
	STRUCT("struct"), SZABO("szabo"), THROW("throw"), UFIXED("ufixed"),
	UINT("uint"), USING("using"), VAR("var"), VIEW("view"), WEEKS("weeks"),
	WEI("wei"), WHILE("while"), YEARS("years"),
